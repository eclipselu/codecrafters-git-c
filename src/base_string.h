...
internal String str_array_join(Arena *a, StringArray *arr, String delimiter) {
  String result = {0};
  ...
  uint64_t num_delimiters = arr->count > 1 ? arr->count - 1 : 0;
  total_size += delimiter.size * num_delimiters;
